...
public class Utilities {
    ...
    //Returns a char array containing every nth char, when sourceArray.length
    // < n, returns sourceArray
    ...
    //"ABBCDEF -> "ABCDEF"
    //ABCDEEF -> "ABCBDEF (the two B's aren't next to each other
    public String removePairs(String source){
        ...
        //Add the final character, which is always safe.  End of array that is not checked against
